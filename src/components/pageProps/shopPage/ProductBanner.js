    ...
    <div className="w-full flex flex-col md:flex-row md:items-center justify-between">
      ...
      <div className="flex items-center gap-2 md:gap-6 mt-4 md:mt-0">
        <div className="flex items-center gap-2 text-base text-[#767676] relative">
          ...
          >
            <option value="Best Sellers">حەبەکان</option>
            <option value="New Arrival">دەرزیەکان</option>
            <option value="Featured">گیراوەکان</option>
            <option value="Final Offer">بابەتی تر</option>
          </select>

          <label className="block">:ڕیزکردن بە</label>
        </div>
        <div className="flex items-center gap-2 text-[#767676] relative">
          ...
          <label className="block">:دانە</label>
        </div>
      </div>
      {/* =========================================================
                            Right Part End here
